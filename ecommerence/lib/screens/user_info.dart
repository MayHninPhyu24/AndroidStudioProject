                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTileSwitch(
                      ...
                      leading: Icon(Typicons.upload_cloud),
                      onChanged: (value) {
                        setState(() {
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: ListTile(
                          onTap: () => Navigator.of(context)
                              .pushNamed(UploadCategoryForm.routeName),
                          title: Text('Upload a new category'),
                          trailing: Icon(Icons.chevron_right_rounded),
                          leading: Icon(Typicons.upload),
                        ),
                      ),
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: ListTile(
                          onTap: () => Navigator.of(context)
                              .pushNamed(UploadBrandForm.routeName),
                          title: Text('Upload a new brand'),
                          trailing: Icon(Icons.chevron_right_rounded),
                          leading: Icon(Typicons.upload),
                        ),
                      ),
