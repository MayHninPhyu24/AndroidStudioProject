...
class _LandingScreenState extends State<LandingScreen> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          CachedNetworkImage(imageUrl: images[1],
            ...
            children: [
                  ...
                  child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children:[
                          ...
                          SizedBox(width: 5,),
                          Icon(Typicons.user_add, size: 18,)
                        ],
                      ),
                  ),
                ),
              ...
              Row(
                children: [
                  ...
                  Text('Or Continuw with', style: TextStyle(
                    color: Colors.black
                  ),),
                  Expanded(
                    child: Padding(
              ...
              Row(
                  ...
                  children:[
                    OutlineButton(onPressed: _googleSignIn,
                      shape: StadiumBorder(),
                    ...
                    _isLoading
                        ...
                        : OutlineButton(onPressed: _loginAnonymously,
                      shape: StadiumBorder(),
