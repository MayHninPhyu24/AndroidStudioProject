    ...
    if (isValid) {
      ...
      try{
        if(_pickedImage == null){
          ...
          final _uid = user.uid;
          final _productId = uuid.v4(); // -> '110ec58a-a0f2-4ac4-8393-c866d813b8d1'

          await FirebaseFirestore.instance.collection('products').doc(_productId)
              .set({
