...
class MoreFlutterUI4 extends StatefulWidget {
  static const routeName = "/MoreFlutterUI4";

  @override
  _MoreFlutterUI4State createState() => _MoreFlutterUI4State();
}

class _MoreFlutterUI4State extends State<MoreFlutterUI4> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: WidgetWithCodeView(
          child: SomeWidget(),
          sourceFilePath: 'lib/more_flutter_ui_screens/UI4.dart',
        ...
        child:Center(
          child: Column(
            children: <Widget>[
              ...
              Expanded(child: charts.BarChart(_chartdata)), //default=>vertical:true
            ],
          ),
        ),
      ),
